...
from setting import AKAS_DF_PATH, AKAS_DF_RESULTS_PATH, TITLE_CREW_DF_PATH, TITLE_CREW_DF_RESULTS_PATH, TITLE_RATINGS_DF_RESULTS_PATH, TITLE_RATINGS_DF_PATH

from my_io import read_akas_df, write_akas_df_to_csv, read_title_crew_df, write_title_crew_df_to_csv, read_title_ratings_df,write_title_ratings_df_to_csv
...
write_title_crew_df_to_csv(TITLE_CREW_DF_RESULTS_PATH)
