from setting import (TITLE_PRINCIPALS_DF_PATH, TITLE_PRINCIPALS_RESULT_PATH,
                     NAME_BASICS_DF_PATH, NAME_BASICS_DF_RESULT_PATH)
...
write_title_principals_df_to_csv(title_principals_df, TITLE_PRINCIPALS_RESULT_PATH)
...
write_name_basics_df_to_csv(name_basics_df, NAME_BASICS_DF_RESULT_PATH)
name_basics_df.show()