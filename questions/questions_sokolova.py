...
# 26. What are the unique IDs and local titles for movies from the regions 'DE' (Germany)
# or 'CH' (Switzerland)?
...
# window functions
# 33. What is the duration of the longest movie for each format, and what is the difference in duration
# between each movie and the longest movie in the same format (possible formats: 'movie', 'short',
# 'tvseries', etc.)?
